...
export default function WhereYouStand({ data }: { data: ReportV2 }) {
  return (
    <section className="py-6 sm:py-8 border-b border-slate-200">
      <p className="text-xs font-semibold uppercase tracking-widest text-[#6c5ce7] mb-2">Section 2 — Where You Stand</p>
      <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-5" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Your numbers vs the industry</h2>
