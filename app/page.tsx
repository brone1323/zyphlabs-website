...
export default function HomePage() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#07090d] text-white">
      <section className="relative isolate flex min-h-[92svh] items-center px-5 pb-16 pt-28 sm:px-6 sm:pb-20 sm:pt-32 lg:px-8">
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="max-w-5xl">
            ...
            <h1
              className="max-w-5xl text-[clamp(3.1rem,11vw,8.3rem)] font-black leading-[0.88] tracking-[-0.07em] text-white"
            ...
            <p className="mt-7 max-w-2xl text-base leading-7 text-white/65 sm:mt-9 sm:text-lg sm:leading-8 lg:text-xl">
              We build fast, modern websites that make your business look established,
              explain your value clearly, and give customers an obvious reason to contact you.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:items-center">
              ...
              <a
                href="#why"
                className="inline-flex min-h-14 items-center justify-center rounded-full border border-white/15 px-7 text-sm font-bold text-white/75 transition hover:border-white/30 hover:bg-white/[0.05] hover:text-white sm:min-h-16"
              >
                See why Zyph Labs
              </a>
            </div>

            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-xs font-semibold uppercase tracking-[0.12em] text-white/40 sm:mt-10 sm:text-sm">
      ...
      <section id="why" className="border-y border-white/10 bg-white/[0.025] px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-[#8ef3dc]">Why it works</p>
              <h2
              ...
              <p className="mt-5 max-w-lg text-base leading-8 text-white/60 sm:text-lg">
                Most business websites have too much text, too many choices, and no clear next step.
                We simplify the experience around what customers actually need to decide.
              </p>
            </div>
            ...
            <div className="grid gap-px overflow-hidden rounded-3xl border border-white/10 bg-white/10 sm:grid-cols-3">
              {benefits.map((benefit) => (
                <article
                  key={benefit.number}
                  className="min-h-[250px] bg-[#0b0e14] p-6 sm:min-h-[320px] sm:p-7 lg:p-8"
                >
                  <p className="text-xs font-black tracking-[0.18em] text-[#8ef3dc]">{benefit.number}</p>
                  <h3 className="mt-14 text-2xl font-black tracking-[-0.04em] sm:mt-20">{benefit.title}</h3>
                  <p className="mt-4 text-sm leading-7 text-white/55 sm:text-base">{benefit.description}</p>
                </article>
              ))}
            </div>
          </div>
      ...
      <section id="services" className="px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-end">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-[#8ab6ff]">More than a website</p>
              <h2
            ...
            <p className="max-w-xl text-base leading-8 text-white/60 sm:text-lg lg:justify-self-end">
              Zyph Labs can also connect lead generation, AI automation, and custom software behind the site.
              But the homepage stays simple: one strong message, one clear next step.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-3 sm:grid-cols-2 lg:mt-16 lg:grid-cols-3">
            {services.map((service) => (
              ...
              >
                <span className="text-lg font-bold tracking-[-0.025em] sm:text-xl">{service}</span>
                <span className="text-xl text-white/30 transition group-hover:translate-x-1 group-hover:text-[#8ef3dc]">↗</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-5 pb-8 sm:px-6 sm:pb-10 lg:px-8 lg:pb-12">
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-white/10 bg-white px-6 py-14 text-[#07090d] sm:px-10 sm:py-20 lg:px-16 lg:py-24">
          ...
          <div className="relative max-w-4xl">
            <p className="text-xs font-black uppercase tracking-[0.2em] text-black/45">Ready when you are</p>
            <h2
